...
class ProductDetailCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var currentBgPercentageColor = StoreAppColors.brandSuccessColor;
    var currentTextPercentageColor = StoreAppColors.brandOnSuccessColor;
    var currentIcon = iconIncomes;
    if (typeProductDetailCard == TypeProductDetailCard.outcomes) {
      currentBgPercentageColor = StoreAppColors.brandErrorColor;
      currentTextPercentageColor = StoreAppColors.brandOnErrorColor;
      ...
      child: Row(
        children: [
          Container(
            ...
            width: 56,
            decoration: const BoxDecoration(
              color: StoreAppColors.brandSecondaryColor,
              ...
              children: [
                Text(
                  ...
                  style: const TextStyle(
                    color: StoreAppColors.brandDarkColor,
                ...
                Padding(
                  ...
                  child: Text(
                    '+\$ $currentSells Hoy',
                    style: const TextStyle(
                      color: StoreAppColors.brandLigthDarkColor,
                      fontFamily: 'RobotoMono',
                      fontSize: 10),
                  ),
                ),
